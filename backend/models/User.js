...
class User {
  constructor(id, display_name, email, role, is_streamer) {
    this.id = id;
  ...
  // Créer ou mettre à jour un utilisateur (SANS colonnes Spotify - stockage en mémoire)
  ...
  // ❌ SUPPRIMÉ : updateSpotifyTokens - Spotify maintenant géré en mémoire
  // ❌ SUPPRIMÉ : getSpotifyTokens - Spotify maintenant géré en mémoire  
  // ❌ SUPPRIMÉ : clearSpotifyTokens - Spotify maintenant géré en mémoire
  // ❌ SUPPRIMÉ : updateSpotifyId - Spotify maintenant géré en mémoire

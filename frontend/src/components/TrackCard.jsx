...
export default function TrackCard({ track, onApprove, onReject, showActions = false }) {
  return (
    <div className="bg-gradient-to-br from-[#2D0036]/60 via-[#0A0A23]/60 to-[#1a1a40]/60 rounded-2xl p-12 shadow-2xl border-2 border-[#CFFF04]/20 backdrop-blur-md">
      <div className="flex items-start justify-between gap-12">
        <div className="flex-1 space-y-4">
          <h3 className="text-4xl font-extrabold text-[#CFFF04] drop-shadow-[0_0_16px_#CFFF04] mb-4">{track.title}</h3>
      ...
      <a
        ...
        className="mt-8 inline-flex items-center text-xl font-bold text-[#CFFF04] hover:text-[#FF4FAD] transition drop-shadow-[0_0_16px_#CFFF04] hover:scale-105"
      >
